...
// configure matcher
    ...
    { // k nearest neighbors (k=2)
        ...
        {
            //matches [1] is the query image (previous frame) and matches [0] is the trained image (current frame)
            // good match is when the distance between the two keypoint is very small
            //decreasing minDescDistRatio will result in more accurate matches 
