...
void clusterHelper(int index,const std::vector<std::vector<float>>& points,std::vector<bool> &processed, std::vector<int> &cluster ,KdTree* tree,float distanceTol){
...
int main ()
{
	...
	// Create data
	std::vector<std::vector<float>> points = { {-6.2,7,1.2}, {-6.3,8.4,1.4}, {-5.2,7.1,4}, {-5.7,6.3,4.2}, {7.2,6.1,4.5}, {8.0,5.3,4}, {7.2,7.1,3.1}, {0.2,-7.1,6}, {1.7,-6.9,6.4}, {-1.2,-7.2,6}, {2.2,-8.9,4} };
    ...
    for (int i=0; i<points.size(); i++) 
  	...
  	std::vector<int> nearby = tree->search({-1.2,-7.2,6},3.0);
